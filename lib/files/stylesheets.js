...
(function() {
  ...
  StylesheetFile = (function(_super) {

    __extends(StylesheetFile, _super);

    function StylesheetFile() {
      return StylesheetFile.__super__.constructor.apply(this, arguments);
    }
  ...
  LessFile = (function(_super) {

    __extends(LessFile, _super);

    function LessFile() {
      return LessFile.__super__.constructor.apply(this, arguments);
    }
