...
(function() {
  ...
  TemplateFile = (function(_super) {
    ...
    TemplateFile.prototype.findDependencies = function(registry, cb) {
      ...
      while (dirname !== '') {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (this.cleanPath !== layoutPath) {
            tries.push(layoutPath);
          }
        }
      }
    ...
    TemplateFile.prototype.read = function(cb) {
      var _this = this;
      if (this.lastRead > this.stats.mtime) {
        return cb(null, this.lastFile);
      }
    ...
    TemplateFile.prototype.compile = function(str, options, cb) {
      ...
      return TemplateFile.__super__.compile.call(this, str, options, function(err, str) {
        if (err || _this.dependsOn.length === 0) {
          return cb(err, str);
        }
        options.body = str;
